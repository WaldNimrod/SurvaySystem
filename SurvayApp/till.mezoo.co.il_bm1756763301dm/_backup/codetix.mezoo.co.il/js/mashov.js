...
$(document).ready(function () {
    ...
    if (Data.Social_desirability_ReRun == 'false' || Data.Social_desirability_ReRun == 'Yes') {
        if (Data.Social_desirability_ReRun != 'Yes') {
            $('#Social_desirability_ReRun').hide();
        }
        $('[id=Group1]').hide();
        if (parseInt(Data.Dims.dim_sumTotal.res) <= parseInt(Data.Dims.dim_sumTotal.threshold)) {
            $('[id=Group3]').hide();
        }
        else {
            $('[id=Group2]').hide();
        ...
        if (Data.Social_desirability_ReRun == 'double') {
            $('[id=Group2]').hide();
            $('[id=Group3]').hide();
        }

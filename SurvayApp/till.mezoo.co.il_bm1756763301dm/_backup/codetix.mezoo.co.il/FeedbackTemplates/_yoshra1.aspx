<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yoshra1.aspx.cs" Inherits="SurveyWeb.FeedbackTemplates.yoshra1" %>
...
<head>
    ...
    <script src="../js/mashov.js" type="text/javascript"></script>
</head>

<body>
<span id="TextData" runat="server" style="display: none;"></span>
<div class="container">
 <img src="..\pics\logo-small.jpg" alt="Insert Logo Here" name="Insert_logo" width="850" height="71" id="Insert_logo" style="background: #C6D580; display:block;" />

  <div class="content">
    <h1>סודי - אישי<br />דו"ח התאמה לתפקיד עמוד 1 מתוך 4</h1>
...
<br />
<br />
<strong>[כאן יש להוסיף רווח כך שבמצב הסופי בהדפסה נעבור לעמוד חדש]
</strong><br />
<br />
<br />
<br />
  ...
  <h1>סודי - אישי<br />דו"ח התאמה לתפקיד עמוד 2 מתוך 4</h1>
  <table  border="0" cellpadding="2" cellspacing="0" class="PersonalData">
	...
	<div style="width:850px; position:relative;">
      <div class="ParamContainer" id="dim_mnipulation">
    		...
    		<div class="SliderContainer"><img src="..\pics\SliderBg.jpg" width="390" height="50" /></div>
     	 	<div class="Slider_Arrow"><img src="..\pics\arrow.png" /></div>   
      </div>
  </div>
  <div style="width:850px; position:relative;">
 ...
 <div style="width:850px; position:relative;">
  ...
  <div style="width:850px; position:relative;">
    ...
    <hr />
    <h1>סודי - אישי<br />
    דו"ח התאמה לתפקיד עמוד 3 מתוך 4</h1>
<h2>מאפיינים</h2>
 <p> aaa
...
<h3>על מנת לקבל החלטה לגבי המועמד מומלץ לבחון את רמת היושרה באמצעים נוספים.</h3>
  ...
  המועמד שייך לקבוצה שאחוז גבוה של האנשים הכלולים בה הנם בעלי <span class="BlueText">רמת יושרה גבוהה.</span> הם נוהגים לפי הנורמות המקובלות, שומרים על נהלים וחוקים, לוקחים אחריות על פעולותיהם ואינם מנצלים אחרים לתועלתם. המועמד ענה על מבחן המצפוניות ברצייה חברתית גבוהה ולמרות זאת, 
